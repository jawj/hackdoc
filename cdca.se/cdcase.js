...
var albumQuery, fix, font, fontBold, loadAssets, mm2pt, nAmerica, pageSize, pageSizes, pw, _ref, _ref1, _ref2;
...
nAmerica = (typeof google !== "undefined" && google !== null) && ((_ref = (_ref1 = google.loader.ClientLocation) != null ? (_ref2 = _ref1.address) != null ? _ref2.country_code : void 0 : void 0) === 'US' || _ref === 'CA');
...
albumQuery = 'http://ws.audioscrobbler.com/2.0/?' + 'api_key=2113885e020cefe1d72f95d8378d32c1&method=album.getinfo&autocorrect=1&format=json&callback=<cb>&' + location.search.substring(1);
...
loadAssets = function() {
  ...
  return jsonp({
    ...
    success: function(albumData) {
      ...
      return PDFImage.xhr({
        url: imgUrl.replace(/^http:\//, 'http://mackerron.com/cdcase.images.proxy'),
...
pw = new ParallelWaiter(2, function(data) {
  var albumName, artist, artistFlow, artistPara, backContent, bgCol, black, c, cs, div, dur, durFlow, durMatch, durMaxWidth, durRe, fgCol, filename, fontBoldObj, fontObj, frontContent, height, i, imgObj, insideFlow, insidePara, insideSize, insideText, k, maxSpineWidth, maxTrackHeight, maxTrackWidth, mediaBox, mins, name, nameFlow, namePara, num, numAndDurSize, numFlow, numMatch, numMaxWidth, numRe, pdf, releaseStr, releasedate, s, secs, spineCommands, spineSize, spineSpace, spineXHeightFactor, t, totalWidth, track, trackCommands, trackData, trackSize, trackSpacing, trackText, tracks, v, wDist, white, _i, _j, _k, _l, _len, _len1, _len2, _m, _ref3, _ref4;
...
//# sourceMappingURL=cdcase.js.map
