...
angular.module('cdca.se').value('makePDF', function(opts) {
  var artistFlow, artistPara, backContent, bgCol, dur, durFlow, durMatch, durMaxWidth, durRe, fgCol, fix, font, fontBold, fontBoldObj, fontObj, frontContent, height, i, imgObj, imgOpts, insideFlow, insidePara, insideSize, k, maxSpineWidth, maxTrackHeight, maxTrackWidth, mediaBox, mm2pt, name, nameFlow, namePara, num, numAndDurSize, numFlow, numMatch, numMaxWidth, numRe, pageSize, pageSizes, pdf, spineCommands, spineSize, spineSpace, spineXHeightFactor, t, totalWidth, track, trackCommands, trackData, trackSize, trackSpacing, v, _i, _j, _k, _l, _len, _len1;
  ...
  pageSize = pageSizes[opts.letterpaper ? 'letter' : 'a4'];
  if (opts.times) {
    font = 'Times-Roman';
    fontBold = 'Times-Bold';
  } else {
