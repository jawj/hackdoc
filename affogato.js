...
(function() {
  ...
  this.BinStringReader = (function() {

    function BinStringReader(str) {
      this.str = str;
      this.offset = 0;
    }

    BinStringReader.prototype.skip = function(n) {
      return this.offset += n;
    };

    BinStringReader.prototype.chars = function(n, str) {
      var i, _i;
      if (str == null) {
        str = '';
      }
    ...
    BinStringReader.prototype.uchar = function() {
      return this.str.charCodeAt(this.offset++) & 0xff;
    };

    BinStringReader.prototype.uint16be = function() {
      return (this.uchar() << 8) + this.uchar();
    };

    BinStringReader.prototype.uint32be = function() {
      return (this.uint16be() << 16) + this.uint16be();
    };

    BinStringReader.prototype.eof = function() {
